...
import { revokeAllUserSessions } from "../../sessions/session.service.js";
...
export async function resetPassword(
  ...
  await updateUserPasswordHash(authToken.userId, newPasswordHash);

  await consumePasswordResetAuthToken(authToken.id);
