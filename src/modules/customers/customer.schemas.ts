...
const customerSchema = z.object({
  type: customerTypeSchema.default(
    "INDIVIDUAL",
  ),
  ...
  discountPercent: z
    ...
    .min(
      0,
      "Customer discount cannot be less than 0%.",
    )
    .max(
      100,
    ...
    (data, context) => {
      ...
      if (
        ...
        context.addIssue({
          ...
          path: ["companyName"],
          message:
            "A business customer requires a company name.",
        });
      }
    },
  );
...
export const listCustomersQuerySchema =
  z.object({
    search: z
      ...
      .max(
        100,
        "Customer search cannot exceed 100 characters.",
      )
      .optional(),
...
export type ListCustomersQueryInput =
  z.infer<
